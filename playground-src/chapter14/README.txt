...
1. Double-click chapter14.Rproj. RStudio opens with this folder as the working directory.
...
install.packages("tidymodels")   # nnet comes with R
...
https://polla-fattah.github.io/R4NTR/playground/chapter14.html
