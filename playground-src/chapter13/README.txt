...
1. Double-click chapter13.Rproj. RStudio opens with this folder as the working directory.
...
install.packages(c("dplyr", "ggplot2", "mclust", "dbscan", "factoextra"))
...
https://polla-fattah.github.io/R4NTR/playground/chapter13.html
