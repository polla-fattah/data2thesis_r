...
| **Quarto** | Turns documents with code into reports and books (Chapter 16) | Comes with RStudio |
...
RStudio includes **Quarto**, so the reports of Chapter 16 work without installing anything else. For PDF output, Quarto also needs LaTeX; install a small version once by typing `quarto install tinytex` in RStudio's **Terminal** tab.
...
- **General > Basic**: untick *Restore .RData into workspace at startup*, and set *Save workspace to .RData on exit* to **Never**. Every session then starts clean, and your scripts, not a hidden saved workspace, hold your work. This is the single most important setting for reproducible work (Chapter 16).
...
| 4–6 | ggplot2, psych |
| 7 | broom, car |
| 8 | psych, GPArotation, corrplot, factoextra |
| 9 | lme4, lmerTest |
| 10–12 | tidymodels, kknn, ranger, kernlab, themis, glmnet, xgboost |
| 13 | mclust, dbscan, factoextra, cluster |
| 14 | tidymodels (nnet comes with R) |
| 15 | tsibble, fable, feasts, urca |
| 16 | rmarkdown, knitr, shiny, bslib, renv, usethis |
| 17 | ellmer, stringr, yardstick |
| 18 | patchwork, broom, lme4 |
...
### Elaf's data: the data2thesis package
