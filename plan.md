...
6. [x] **Write the new chapters** (9, 17, 18) and appendices B–E. (Done 2026-09-24; Chapter 17's language-model results await the author's run of `data-raw/run_ai_coding.R`.)
